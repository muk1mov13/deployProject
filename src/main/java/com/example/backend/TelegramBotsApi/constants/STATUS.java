...
//    status for telegram user
    ...
    //    STEP 1
    START_MENU_WAITING, SEND_PASSWORD, BLOCKED,AGENT_MENU,


    ADD_NEW_CLIENT, SEND_CUSTOMER_CATEGORIES, SEND_TERRITORIES, SEND_FULL_NAME, SEND_ADDRESS, SEND_PHONE, SEND_INN, SEND_LOCATION, SEE_CLIENTS,
